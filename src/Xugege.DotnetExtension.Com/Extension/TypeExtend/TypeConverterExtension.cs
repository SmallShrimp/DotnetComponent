...
namespace Xugege.DotnetExtension.Com.Extension.TypeExtend
{
    public static class TypeConverterExtension
    {
        public static List<T> TryParser<T>(string value)
        {
        ...
        public static bool TryParser(string value, Type outType, out object dValue)
        {
            try
            {
